...
__all__ = ['set_dirp_dll', 'DIRP_PSEUDO_COLOR_WHITEHOT', 'DIRP_PSEUDO_COLOR_FULGURITE', 'DIRP_PSEUDO_COLOR_IRONRED',
           ...
           'dirp_create_from_rjpeg', 'dirp_destroy', 'dirp_get_api_version', 'dirp_get_color_bar',
